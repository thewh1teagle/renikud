...
Usage:
    uv run src/infer_classifier.py --checkpoint outputs/g2p-classifier/checkpoint-5000 --text "שלום עולם"
"""
...
def load_classifier_checkpoint(model: HebrewG2PClassifier, checkpoint_dir: str) -> None:
...
def main():
    ...
    load_classifier_checkpoint(model, args.checkpoint)
